...
import com.nayana.bhoj.apps.currencyconverter.charts.ChartsFragment;
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0: // Fragment # 0 - This will show FirstFragment
                return FirstFragment.newInstance(0, " FIrst Page # 1");
            case 1: // Fragment # 0 - This will show FirstFragment different title
                //return SecondFragment.newInstance(1, " second Page # 2");
